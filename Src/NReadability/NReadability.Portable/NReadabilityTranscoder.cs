...
namespace NReadability
{
  ...
  public class NReadabilityTranscoder
  {
    ...
    private static readonly string _ReadabilityStylesheetResourceName = typeof(NReadabilityTranscoder).Namespace + ".Portable.Resources.readability.css";
    ...
    public const string InnerDivId = "readInner";
    public const string ContentDivId = "readability-content";
    public const string ReadabilityStyledCssClass = "readability-styled";
    ...
    public void GlueDocument(XDocument document, XElement articleTitleElement, XElement articleContentElement)
    {
      XElement documentBody = GetOrCreateBody(document);
    ...
    public void StripUnlikelyCandidates(XDocument document)
    {
    ...
    public void CollapseRedundantParagraphDivs(XDocument document)
    {
      XElement rootElement = document.Root;
    ...
    public IEnumerable<XElement> FindCandidatesForArticleContent(XDocument document, string articleContentElementHint = null)
    {
      ...
      foreach (XElement paraElement in paraElements)
      {
        ...
        if (parentElement != null && !"body".Equals(parentElement.Name.LocalName, StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (grandParentElement != null && !"body".Equals(grandParentElement.Name.LocalName, StringComparison.OrdinalIgnoreCase))
        {
    ...
    public XElement DetermineTopCandidateElement(XDocument document, IEnumerable<XElement> candidatesForArticleContent)
    {
    ...
    public XElement CreateArticleContentElement(XDocument document, XElement topCandidateElement)
    {
    ...
    public void PrepareArticleContentElement(XElement articleContentElement)
    {
    ...
    public float GetLinksDensity(XElement element)
    {
    ...
    public string GetUserStyleClass(string prefix, string enumStr)
    {
      ...
      bool wasUpperCaseCharacterSeen = false;
        ...
        for (int i = 0; i < enumStr.Length; i++)
        {
            ...
            if (Char.IsUpper(ch))
            {
                ...
                suffixSB.Append(Char.ToLower(ch));
            }
            else
            {
                suffixSB.Append(ch);
